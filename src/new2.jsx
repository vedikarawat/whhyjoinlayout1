...
//     const translateY = offset * (isSmallScreen ? 6 : 8);
//     const translateX = offset * (isSmallScreen ? 3 : 4);
//     const scale = 1 - offset * (isSmallScreen ? 0.02 : 0.02);
//     const opacity = offset === 0 ? 1 : 0.8 - offset * 0.25;
//     const rotateX = offset * (isSmallScreen ? 0.5 : 1);
...
//       <div className="relative h-[26rem] sm:h-[30rem] md:h-[28rem] lg:h-[30rem] xl:h-[32rem]">
...
//                 {/* Unified Stacked Layout */}
//                 <div className="relative z-10 h-full flex flex-col p-4 sm:p-6 md:p-6 lg:p-8">
...
//                     </div>
//                     {!card.isCover && (
//                       <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-white/20 rounded-full flex items-center justify-center text-sm sm:text-base md:text-lg lg:text-xl font-bold backdrop-blur-sm border border-white/30 shadow-lg">
//                         {index}
//                       </div>
//                     )}
//                   </div>
...
//                   {/* Title Section */}
//                   <div className="flex-shrink-0 mb-3 sm:mb-4 md:mb-4">
//                     <h2
//                       className={`${
//                         card.isCover
//                           ? "text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-bold text-center"
//                           : "text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl font-bold text-center"
//                       } leading-tight`}
//                     >
//                       {card.title}
//                     </h2>
...
//                   {/* Image Section - Middle position */}
//                   <div className="flex-shrink-0 w-full h-32 sm:h-40 md:h-44 lg:h-48 xl:h-52 mb-3 sm:mb-4 md:mb-4 flex items-center justify-center overflow-hidden rounded-lg">
//                     {card.imageUrl && (
//                       <img
//                         src={card.imageUrl}
//                         alt={card.imageAlt}
//                         className={`w-auto h-full max-w-full md:max-w-none md:w-full object-contain transition-opacity duration-300 shadow-lg ${
...
//                   {/* Content Section - Bottom position */}
...
//                         } leading-relaxed opacity-90 font-medium text-center overflow-hidden`}
//                         style={{
//                           display: '-webkit-box',
//                           WebkitLineClamp: card.isCover ? '3' : '4',
...
//                     {!card.isCover && (
//                       <div className="mt-2 sm:mt-3 md:mt-3 flex justify-center flex-shrink-0">
