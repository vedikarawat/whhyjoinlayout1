        ...
        {flashcards.map((card, index) => {
          ...
          return (
            ...
            >
              {/* Card Content */}
              <div
                className={`w-full h-full bg-gradient-to-br ${card.gradient} rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-3xl shadow-2xl shadow-[#60a5fa]/40 text-white relative overflow-hidden border border-[#93c5fd]/30 backdrop-blur-sm transform transition-all duration-200 hover:shadow-3xl hover:shadow-[#60a5fa]/60 hover:border-[#93c5fd]/50`}
              >
                {/* Background Image */}
                {card.imageUrl && (
